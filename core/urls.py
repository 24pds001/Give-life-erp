...
urlpatterns = [
    ...
    path('inventory/create/', views.create_inventory_log, name='create_inventory_log'),
    path('inventory/close/<int:pk>/', views.close_inventory_log, name='close_inventory_log'),
    ...
    path('worklogs/create/', views.create_worklog, name='create_worklog'),
